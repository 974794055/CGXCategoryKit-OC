Pod::Spec.new do |s|
    ...
    s.subspec 'Tools' do |ss|
        ...
        ss.public_header_files = 'CGXCategoryKitOC/Tools/**/*.{h,m}'
    end
    ...
    s.subspec 'Foundation' do |ss|
        ...
        ss.subspec 'NSCalendar' do |sss|
            ...
            sss.public_header_files = 'CGXCategoryKitOC/Foundation/NSCalendar/**/*.{h,m}'
        end
        ss.subspec 'NSDate' do |sss|
            sss.source_files = 'CGXCategoryKitOC/Foundation/NSDate/**/*.{h,m}'
            sss.public_header_files = 'CGXCategoryKitOC/Foundation/NSDate/**/*.{h,m}'
    ...
    s.subspec 'CoreLocation' do |ss|
        ss.subspec 'CLLocation' do |sss|
            ...
            sss.public_header_files = 'CGXCategoryKitOC/CoreLocation/CLLocation/**/*.{h,m}'
        end
    end
