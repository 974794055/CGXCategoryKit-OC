...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        ...
        Method replaceMethod = class_getInstanceMethod([UIScrollView class], @selector(stopScroll_setDelegate:));
...
- (void)stopScroll_setDelegate:(id<UIScrollViewDelegate>)delegate {
    [self stopScroll_setDelegate:delegate];
