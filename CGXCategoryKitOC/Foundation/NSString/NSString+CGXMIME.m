...
@implementation NSString (CGXMIME)
/**
...
- (NSString *)gx_MIMEType {
    return [[self class] gx_MIMETypeForExtension:[self pathExtension]];
}

+ (NSString *)gx_MIMETypeForExtension:(NSString *)extension {
    return [[self gx_MIMEDict] valueForKey:[extension lowercaseString]];
}
/**
 *  @brief  常见MIME集合
 *
