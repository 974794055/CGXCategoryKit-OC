...
@implementation NSString (CGXScore)

- (CGFloat)gx_scoreAgainst:(NSString *)otherString{
    return [self gx_scoreAgainst:otherString fuzziness:nil];
}

- (CGFloat)gx_scoreAgainst:(NSString *)otherString fuzziness:(NSNumber *)fuzziness{
    return [self gx_scoreAgainst:otherString fuzziness:fuzziness options:CGXScoreOptionNone];
}

- (CGFloat)gx_scoreAgainst:(NSString *)anotherString fuzziness:(NSNumber *)fuzziness options:(CGXScoreOption)options{
    ...
    if(CGXScoreOptionFavorSmallerWords == (options & CGXScoreOptionFavorSmallerWords)){
    ...
    if(CGXScoreOptionReducedLongStringPenalty == (options & CGXScoreOptionReducedLongStringPenalty)){
