...
+ (UIFont *)gx_fontWithTTFAtPath:(NSString *)path size:(CGFloat)size;

/**
 *  @brief  Convenience method that calls gx_fontWithTTFAtPath:size: after creating a path from the provided URL.
 *
...
+ (UIFont *)gx_fontWithTTFAtURL:(NSURL *)URL size:(CGFloat)size;
