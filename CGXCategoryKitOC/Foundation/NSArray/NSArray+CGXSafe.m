...
- (NSArray *)gx_arrayByReplacingNullsWithBlanks
{
    ...
    for (int idx = 0; idx < [replaced count]; idx++) {
        ...
        else if ([object isKindOfClass:[NSArray class]]) [replaced replaceObjectAtIndex:idx withObject:[object gx_arrayByReplacingNullsWithBlanks]];
    }
...
{
    [objc_getClass(NSArray0) gx_swizzleClassInstanceMethodWithOriginSel:@selector(objectAtIndex:) swizzleSel:@selector(array0_objectAtIndex:)];
    [objc_getClass(NSArray0) gx_swizzleClassInstanceMethodWithOriginSel:@selector(subarrayWithRange:) swizzleSel:@selector(array0_subarrayWithRange:)];
    [objc_getClass(NSArray0) gx_swizzleClassInstanceMethodWithOriginSel:@selector(indexOfObject:inRange:) swizzleSel:@selector(array0_indexOfObject:inRange:)];
    [objc_getClass(NSArray0) gx_swizzleClassInstanceMethodWithOriginSel:@selector(objectsAtIndexes:) swizzleSel:@selector(array0_objectsAtIndexes:)];
    [objc_getClass(NSArray0) gx_swizzleClassInstanceMethodWithOriginSel:@selector(objectAtIndexedSubscript:) swizzleSel:@selector(array0_objectAtIndexedSubscript:)];
    [objc_getClass(NSArray0) gx_swizzleClassInstanceMethodWithOriginSel:@selector(enumerateObjectsAtIndexes:options:usingBlock:) swizzleSel:@selector(array0_enumerateObjectsAtIndexes:options:usingBlock:)];
    [objc_getClass(NSArray0) gx_swizzleClassInstanceMethodWithOriginSel:@selector(indexOfObjectAtIndexes:options:passingTest:) swizzleSel:@selector(array0_indexOfObjectAtIndexes:options:passingTest:)];
    [objc_getClass(NSArray0) gx_swizzleClassInstanceMethodWithOriginSel:@selector(indexesOfObjectsAtIndexes:options:passingTest:) swizzleSel:@selector(array0_indexesOfObjectsAtIndexes:options:passingTest:)];
    [objc_getClass(NSArray0) gx_swizzleClassInstanceMethodWithOriginSel:@selector(indexOfObject:inSortedRange:options:usingComparator:) swizzleSel:@selector(array0_indexOfObject:inSortedRange:options:usingComparator:)];
}
+ (void)swizzleNSSingleObjectArrayIMethod
{
    [objc_getClass(NSSingleObjectArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(objectAtIndex:) swizzleSel:@selector(singleObjectArrayI_objectAtIndex:)];
    [objc_getClass(NSSingleObjectArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(subarrayWithRange:) swizzleSel:@selector(singleObjectArrayI_subarrayWithRange:)];
    [objc_getClass(NSSingleObjectArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(indexOfObject:inRange:) swizzleSel:@selector(singleObjectArrayI_indexOfObject:inRange:)];
    [objc_getClass(NSSingleObjectArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(objectsAtIndexes:) swizzleSel:@selector(singleObjectArrayI_objectsAtIndexes:)];
    [objc_getClass(NSSingleObjectArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(objectAtIndexedSubscript:) swizzleSel:@selector(singleObjectArrayI_objectAtIndexedSubscript:)];
    [objc_getClass(NSSingleObjectArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(enumerateObjectsAtIndexes:options:usingBlock:) swizzleSel:@selector(singleObjectArrayI_enumerateObjectsAtIndexes:options:usingBlock:)];
    [objc_getClass(NSSingleObjectArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(indexOfObjectAtIndexes:options:passingTest:) swizzleSel:@selector(singleObjectArrayI_indexOfObjectAtIndexes:options:passingTest:)];
    [objc_getClass(NSSingleObjectArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(indexesOfObjectsAtIndexes:options:passingTest:) swizzleSel:@selector(singleObjectArrayI_indexesOfObjectsAtIndexes:options:passingTest:)];
    [objc_getClass(NSSingleObjectArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(indexOfObject:inSortedRange:options:usingComparator:) swizzleSel:@selector(singleObjectArrayI_indexOfObject:inSortedRange:options:usingComparator:)];
}

+ (void)swizzleNSArrayIMethod
{
    [objc_getClass(NSArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(objectAtIndex:) swizzleSel:@selector(arrayI_objectAtIndex:)];
    [objc_getClass(NSArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(subarrayWithRange:) swizzleSel:@selector(arrayI_subarrayWithRange:)];
    [objc_getClass(NSArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(indexOfObject:inRange:) swizzleSel:@selector(arrayI_indexOfObject:inRange:)];
    [objc_getClass(NSArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(objectsAtIndexes:) swizzleSel:@selector(arrayI_objectsAtIndexes:)];
    [objc_getClass(NSArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(objectAtIndexedSubscript:) swizzleSel:@selector(arrayI_objectAtIndexedSubscript:)];
    [objc_getClass(NSArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(enumerateObjectsAtIndexes:options:usingBlock:) swizzleSel:@selector(arrayI_enumerateObjectsAtIndexes:options:usingBlock:)];
    [objc_getClass(NSArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(indexOfObjectAtIndexes:options:passingTest:) swizzleSel:@selector(arrayI_indexOfObjectAtIndexes:options:passingTest:)];
    [objc_getClass(NSArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(indexesOfObjectsAtIndexes:options:passingTest:) swizzleSel:@selector(arrayI_indexesOfObjectsAtIndexes:options:passingTest:)];
    [objc_getClass(NSArrayI) gx_swizzleClassInstanceMethodWithOriginSel:@selector(indexOfObject:inSortedRange:options:usingComparator:) swizzleSel:@selector(arrayI_indexOfObject:inSortedRange:options:usingComparator:)];
}
